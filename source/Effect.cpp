...
void Effect::SetNormalMap(const std::string& filePath, ID3D11Device* pDevice) const
{
...
void Effect::SetSpecularMap(const std::string& filePath, ID3D11Device* pDevice) const
{
...
void Effect::SetGlossinessMap(const std::string& filePath, ID3D11Device* pDevice) const
{
